...
# Load the data
df = read.csv("paper/outputs/s3e_sirmodel.csv")
df_eepost = read.csv("paper/outputs/s3e_sirmodel_epiestimposteriors.csv")
df_efpost = read.csv("paper/outputs/s3e_sirmodel_epifilterposteriors.csv")
...
plt
ggsave(paste0("paper/figures/s3e_sir.png"), plt, dpi=300, width=20, height=21, units="cm")
