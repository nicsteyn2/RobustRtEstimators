...
# Load the data
df = read.csv("paperv2/outputs/s3d_obsnoise.csv")
df_eepost = read.csv("paperv2/outputs/s3d_obsnoise_epiestimposteriors.csv")
df_efpost = read.csv("paperv2/outputs/s3d_obsnoise_epifilterposteriors.csv")
...
plt
ggsave(paste0("paperv2/figures/s3d_obsnoise.png"), plt, dpi=300, width=25, height=21, units="cm")
