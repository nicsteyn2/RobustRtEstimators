...
# Load the data
df = read.csv("paper/outputs/s5anzmovingaverage.csv")
df_eepost = read.csv("paper/outputs/s5anzmovingaverage_epiestimposteriors.csv")
df_efpost = read.csv("paper/outputs/s5anzmovingaverage_epifilterposteriors.csv")
...
plt
ggsave(paste0("paper/figures/s5a_nzma.png"), plt, dpi=300, width=25, height=21, units="cm")
