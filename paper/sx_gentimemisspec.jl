...
CSV.write("paper/outputs/s9_SImisspec.csv", out_all)
CSV.write("paper/outputs/s9_SImisspec_epiestimposteriors.csv", ee_parampost_all)
CSV.write("paper/outputs/s9_SImisspec_epifilterposteriors.csv", ef_parampost_all)