...
CSV.write("paper/outputs/s5e_sirmodel.csv", out_all)
CSV.write("paper/outputs/s5e_sirmodel_epiestimposteriors.csv", ee_parampost_all)
CSV.write("paper/outputs/s5e_sirmodel_epifilterposteriors.csv", ef_parampost_all)