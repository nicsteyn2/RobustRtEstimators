...
plotEtaFinal = plot!(plotEtaFinal, ηgrid[1:findfirst(ηgrid .>= 0.5)], pη[1:findfirst(ηgrid .>= 0.5),end], fillalpha=0.2, label="Coarser grid")
...
plotEtaFinal = plot!(plotEtaFinal, ηgrid[1:findfirst(ηgrid .>= 0.5)], pη[1:findfirst(ηgrid .>= 0.5),end], fillalpha=0.2, label="Finer grid")
...
# png("paper/figures/s9_gridsize_epifilter_Rgrid.png")
savefig(plt, "paper/figures/s9_gridsize_epifilter_Rgrid.pdf")