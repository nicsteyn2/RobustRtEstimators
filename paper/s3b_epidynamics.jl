...
function runVaryingRW( ; nIter=10)
    ...
    for jj in 1:nIter
        ...
        for (ii, η) in enumerate(ηvals)
            ...
            CSV.write("paperv2/outputs/s3b_varying_rw.csv", out_all)
            CSV.write("paperv2/outputs/s3b_varying_rw_eepost.csv", ee_parampost_all)
            CSV.write("paperv2/outputs/s3b_varying_rw_efpost.csv", ef_parampost_all)
...
function runVaryingSinusoidal( ; nIter=10)
    ...
    for jj in 1:nIter
        ...
        for (ii, ω) in enumerate(ωvals)
            ...
            CSV.write("paperv2/outputs/s3b_varying_sinusoidal.csv", out_all)
            CSV.write("paperv2/outputs/s3b_varying_sinusoidal_eepost.csv", ee_parampost_all)
            CSV.write("paperv2/outputs/s3b_varying_sinusoidal_efpost.csv", ef_parampost_all)
...
function runVaryingStepChange( ; nIter=10)
    ...
    for jj in 1:nIter
        ...
        for (ii, changePoint) in enumerate(changePoints)
            ...
            CSV.write("paperv2/outputs/s3b_varying_stepchanges.csv", out_all)
            CSV.write("paperv2/outputs/s3b_varying_stepchanges_eepost.csv", ee_parampost_all)
            CSV.write("paperv2/outputs/s3b_varying_stepchanges_efpost.csv", ef_parampost_all)
