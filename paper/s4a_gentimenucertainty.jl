...
CSV.write("paper/outputs/s4a_epifilter_siuncertainty.csv", EpiFilterSI)
CSV.write("paper/outputs/s4a_epifilter_siuncertainty_params.csv", EpiFilterSI_params)

(EpiEstimSI, EpiEstimSI_params) = FitEpiEstim_SIUncertainty(serial_interval, Ct, Rt, "Random walk"; N=50)
CSV.write("paper/outputs/s4a_epiestim_siuncertainty.csv", EpiEstimSI)
CSV.write("paper/outputs/s4a_epiestim_siuncertainty_params.csv", EpiEstimSI_params)
