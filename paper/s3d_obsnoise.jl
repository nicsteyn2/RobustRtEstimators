...
CSV.write("paperv2/outputs/s3d_obsnoise.csv", out_all)
CSV.write("paperv2/outputs/s3d_obsnoise_epiestimposteriors.csv", ee_parampost_all)
CSV.write("paperv2/outputs/s3d_obsnoise_epifilterposteriors.csv", ef_parampost_all)