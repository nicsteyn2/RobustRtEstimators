...
# Load the data
df = read.csv("paper/outputs/s9_SImisspec.csv") %>% filter(fit=="Marginalised")
df_params_ee = read.csv("paper/outputs/s9_SImisspec_epiestimposteriors.csv") 
df_params_ef = read.csv("paper/outputs/s9_SImisspec_epifilterposteriors.csv") 
...
plt_with_legend
ggsave(paste0("paper/figures/sx_gentimemisspec.png"), plt_with_legend, dpi=300, width=20, height=14, units="cm")
