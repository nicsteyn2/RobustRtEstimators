...
function runVaryingC0_sinusoidal(; nIter=10)
    ...
    for jj in 1:nIter
        ...
        for (ii, C0) in enumerate(C0vals)
            ...
            CSV.write("paperv2/outputs/s3a_varying_C0_sinusoidal.csv", out_all)
            CSV.write("paperv2/outputs/s3a_varying_C0_sinusoidal_eepost.csv", ee_parampost_all)
            CSV.write("paperv2/outputs/s3a_varying_C0_sinusoidal_efpost.csv", ef_parampost_all)
