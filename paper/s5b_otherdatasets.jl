...
function fitModelsToRealWorldData()
    ...
    for source in sources
        ...
        CSV.write("paper/outputs/s5otherdatasets.csv", out_all)
        CSV.write("paper/outputs/s5otherdatasets_epiestimposteriors.csv", ee_parampost_all)
        CSV.write("paper/outputs/s5otherdatasets_epifilterposteriors.csv", ef_parampost_all)
