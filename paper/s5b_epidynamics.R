...
df_eepost = rbind(
  read.csv("paper/outputs/s5b_varying_rw_eepost.csv"),
  read.csv("paper/outputs/s5b_varying_sinusoidal_eepost.csv"),
  read.csv("paper/outputs/s5b_varying_stepchanges_eepost.csv")
) %>% mutate(TrueParam = case_when(TrueParam==51 ~ 1,
                                   TrueParam==34 ~ 2,
                                   TrueParam==26 ~ 3,
                                   TrueParam==21 ~ 4,
...
df_efpost = rbind(
  read.csv("paper/outputs/s5b_varying_rw_efpost.csv"),
  read.csv("paper/outputs/s5b_varying_sinusoidal_efpost.csv"),
  read.csv("paper/outputs/s5b_varying_stepchanges_efpost.csv")
) %>% mutate(TrueParam = case_when(TrueParam==51 ~ 1,
                                   TrueParam==34 ~ 2,
                                   TrueParam==26 ~ 3,
                                   TrueParam==21 ~ 4,
